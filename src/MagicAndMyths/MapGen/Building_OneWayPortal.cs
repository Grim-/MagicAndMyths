...
namespace MagicAndMyths
{
    public class Building_OneWayPortal : Building
    {
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            {
              //  portalEffect = MagicAndMythDefOf.Portal_Effect.SpawnMaintained(this, this.Map, 4f);
            }
        }
        ...
        //    var worldComp = Find.World.GetComponent<GateWorldManager>();
        //    int destinationTile = worldComp.ResolveTileFromAddress(destinationAddress);
        //    if (destinationTile == -1) return null;

        //    var siteManager = Find.World.GetComponent<WorldCustomSiteManager>();
        //    return siteManager.GetOrCreateMapForTile(destinationTile, this.Map);
        //}
