...
namespace MagicAndMyths
{
    ...
    //    public static bool IsConnectionValid(RoomConnection connection, Dictionary<DungeonRoom, int> connectionCounts)
    //    {
    ...
    //    //    List<DungeonRoom> nodes,
    //    //    List<RoomConnection> validConnections,
    //    //    Dictionary<DungeonRoom, int> connectionCounts)
    //    //{
    ...
    //    //                node.roomCells.CenterCell.ToVector3(),
    //    //                n.roomCells.CenterCell.ToVector3()))
    //    //            .ToList();
    ...
    //    //            newConnection.corridors = CorridoorUtility.GenerateCorridors(map, node, target);
    ...
    //    private static RoomType GetRoomType(DungeonRoom node)
    //    {
