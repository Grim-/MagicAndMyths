...
{
    public class HediffCompProperties_MeleeAttackAddHediff : HediffCompProperties
    {
        ...
        public HediffCompProperties_MeleeAttackAddHediff()
        {
            compClass = typeof(HediffComp_MeleeAttackAddHediff);
        }
    }

    public class HediffComp_MeleeAttackAddHediff : HediffComp_OnMeleeAttackEffect
    {
        HediffCompProperties_MeleeAttackAddHediff Props => (HediffCompProperties_MeleeAttackAddHediff)props;
