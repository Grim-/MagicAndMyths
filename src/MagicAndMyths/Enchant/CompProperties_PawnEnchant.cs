...
namespace MagicAndMyths
{
    ...
    public class Comp_PawnEnchant : ThingComp
    {
        ...
        public DamageWorker.DamageResult Notify_ApplyMeleeDamageToTarget(LocalTargetInfo target, Pawn Attacker, ref DamageWorker.DamageResult DamageWorkerResult)
        {
            ...
            foreach (var enchantData in activeEnchants)
            {
                ...
                {
                    DamageWorkerResult = enchantData.EnchantInstance.Notify_ApplyMeleeDamageToTarget(target, Attacker, ref DamageWorkerResult);
                }
            }
