...
{
    public class MagicAndMythsMod : Mod
    {
        private AbilityRadialPagerSettings settings;
        private Vector2 scrollPosition;

        public MagicAndMythsMod(ModContentPack content) : base(content)
        {
            this.settings = GetSettings<AbilityRadialPagerSettings>();
        }

        public static AbilityRadialPagerSettings Settings => LoadedModManager.GetMod<MagicAndMythsMod>().GetSettings<AbilityRadialPagerSettings>();
