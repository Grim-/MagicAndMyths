...
namespace MagicAndMyths
{
    ...
    public class CompProperties_SweepingStrike: CompProperties_BaseWeaponAbility
    {
        public int range = 10;
    ...
    public class CompAbilityEffect_SweepingStrike : CompAbilityEffect_BaseWeaponAbility
    {
