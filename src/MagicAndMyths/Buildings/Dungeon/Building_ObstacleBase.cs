...
{
    public abstract class Building_ObstacleBase : Building_DungeonBuildingBase
    {
        ...
        protected SolutionWorker currentSolution;


        public virtual void SetCurrentWorkedSolution(SolutionWorker compSolution)
        {
            currentSolution = compSolution;
        }
